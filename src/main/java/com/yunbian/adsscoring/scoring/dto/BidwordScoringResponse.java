...
public class BidwordScoringResponse {
    ...
    public List<BidwordScoringRow> getRows() {
        return rows;
    }

    public void setRows(List<BidwordScoringRow> rows) {
        this.rows = rows;
    }
    ...
    public static class BidwordScoringRow {
        ...
        public String getBidwordText() {
            return bidwordText;
        }

        public void setBidwordText(String bidwordText) {
            this.bidwordText = bidwordText;
        }
