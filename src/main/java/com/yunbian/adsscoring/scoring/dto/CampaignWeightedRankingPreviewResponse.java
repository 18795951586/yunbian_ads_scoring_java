...
public class CampaignWeightedRankingPreviewResponse {
    ...
    private List<CampaignWeightedRankingRow> rows;
    ...
    public List<CampaignWeightedRankingRow> getRows() {
        return rows;
    }

    public void setRows(List<CampaignWeightedRankingRow> rows) {
        this.rows = rows;
    }
    ...
    public static class CampaignWeightedRankingRow {
