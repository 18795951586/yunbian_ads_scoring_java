...
public class CampaignScoringResponse {
    ...
    private List<CampaignScoringRow> rows;
    ...
    public List<CampaignScoringRow> getRows() {
        return rows;
    }

    public void setRows(List<CampaignScoringRow> rows) {
        this.rows = rows;
    }
    ...
    public static class CampaignScoringRow {
