...
public class AdgroupWeightedRankingPreviewResponse {
    ...
    private List<AdgroupWeightedRankingRow> rows;
    ...
    public List<AdgroupWeightedRankingRow> getRows() {
        return rows;
    }

    public void setRows(List<AdgroupWeightedRankingRow> rows) {
        this.rows = rows;
    }
    ...
    public static class AdgroupWeightedRankingRow {
