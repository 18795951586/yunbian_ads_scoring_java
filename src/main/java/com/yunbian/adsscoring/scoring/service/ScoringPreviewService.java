...
public interface ScoringPreviewService {
    ...
    AdgroupScoringResponse calculateAdgroupScoring(
            Long sid,
            LocalDate logDate,
            Integer effectDays,
            ScoringSchemeCreateRequest request
        ...
        BidwordScoringResponse calculateBidwordScoring(
            Long sid,
            LocalDate logDate,
            Integer effectDays,
            ScoringSchemeCreateRequest request
    ...
    BidwordWeightedRankingPreviewResponse previewBidwordWeightedRanking(
            Long sid,
            LocalDate logDate,
            Integer effectDays,
            ScoringSchemeCreateRequest request
